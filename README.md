# Improving ASR output using LLMs
...
*to view more analysis on how we managed to mix both transcription methods, please refer to the "Error Analysis and Prompts" folder*
